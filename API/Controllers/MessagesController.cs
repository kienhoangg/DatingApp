...
namespace API.Controllers
{
    ...
    public class MessagesController : BaseApiController
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<MemberDto>>> GetMessageForUser([FromQuery] MessageParams messageParams)
        {
        ...
        public async Task<ActionResult> DeleteMessage(int id)
        {
            ...
            return BadRequest("Problem deleting the meessage");
